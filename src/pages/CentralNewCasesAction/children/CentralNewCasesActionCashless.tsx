...
const CentralNewCasesActionCashless: React.FC = () => {
  ...
  const handleViewClick = (investigationID: string, claim: Claim) => {
    navigate(`/admin/fresh-case-form/${investigationID}?redirectTo=${location.pathname}&claimsType=cashless&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}`);
  };
...
export default CentralNewCasesActionCashless;