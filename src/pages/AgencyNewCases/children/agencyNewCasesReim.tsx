...
const AgencyNewCasesReim: React.FC = () => {
    ...
    const fetchAssignedCases = async () => {
        ...
        try {
            ...
            let response: any = await claimsService.getReclaimsAgencyNewCases();
    ...
    const handleTatChange = async (event: any) => {
        ...
        setLoading(true);
        try {
            let response: any = await claimsService.getReclaimsAgencyNewCasesByTat(selectedRange);
    ...
    const handleRowClick = (investigationID: string, claim: any) => {
        navigate(`/admin/fresh-case-form/${investigationID}?redirectTo=${location.pathname}&claimsType=reim&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}&acceptAssId=${claim.acceptAssignId}&invsType=${claim.investigationType}&invsSubType=${claim.investigationSubType}`)
    };
...
export default AgencyNewCasesReim;