...
const AgencyNewCasesCashless: React.FC = () => {
    ...
    const fetchAssignedCases = async () => {
        ...
        try {
            ...
            let response: any = await claimsService.getAgencyNewCases();
    ...
    const handleTatChange = async (event: any) => {
        ...
        setLoading(true);
        try {
            let response: any = await claimsService.getAssignedToSelfCasesByTat(selectedRange);
    ...
    const handleRowClick = (investigationID: string, claim: any) => {
        navigate(`/admin/fresh-case-form/${investigationID}?redirectTo=${location.pathname}&claimsType=cashless&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}&acceptAssId=${claim.acceptAssignId}&invsType=${claim.investigationType}&invsSubType=${claim.investigationSubType}`)
    };
...
export default AgencyNewCasesCashless;