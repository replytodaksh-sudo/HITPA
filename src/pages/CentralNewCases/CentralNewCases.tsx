...
import CentralNewCasesReim from './children/CentralNewCasesReim';
import CentralNewCasesCashless from './children/CentralNewCasesCashless';
...
const CentralNewCases: React.FC = () => {
...
export default CentralNewCases;