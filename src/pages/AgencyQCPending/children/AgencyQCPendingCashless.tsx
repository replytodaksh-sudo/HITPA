// // File: src/components/AgencyQCPendingCashless.tsx
...
//  */
// const AgencyQCPendingCashless: React.FC = () => {
...
// export default AgencyQCPendingCashless;
...
const AgencyQCPendingCashless: React.FC = () => {
    ...
    const fetchAssignedCases = async () => {
        ...
        try {
            ...
            let response: any = await claimsService.getAllAgencyQCPending();
    ...
    const handleTatChange = async (event: any) => {
        ...
        setLoading(true);
        try {
            let response: any = await claimsService.getAllAgencyQCPendingByTat(selectedRange);
    ...
    const handleRowClick = (investigationID: string, claim: any) => {
        navigate(`/admin/agency-qc-pending-form/${investigationID}?redirectTo=${location.pathname}&claimsType=cashless&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}&acceptAssId=${claim.acceptAssignId}&invsType=${claim.investigationType}&invsSubType=${claim.investigationSubType}`)
    };
