...
const AgencyQCPendingReimTable: React.FC = () => {
    ...
    const fetchAssignedCases = async () => {
        ...
        try {
            ...
            let response: any = await claimsService.getAllAgencyQCPendingReim();
    ...
    const handleTatChange = async (event: any) => {
        ...
        setLoading(true);
        try {
            let response: any = await claimsService.getAllAgencyQCPendingReimByTat(selectedRange);
    ...
    const handleRowClick = (investigationID: string, claim: any) => {
        navigate(`/admin/agency-qc-pending-form/${investigationID}?redirectTo=${location.pathname}&claimsType=reim&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}&acceptAssId=${claim.acceptAssignId}&invsType=${claim.investigationType}&invsSubType=${claim.investigationSubType}`)
    };
...
export default AgencyQCPendingReimTable;