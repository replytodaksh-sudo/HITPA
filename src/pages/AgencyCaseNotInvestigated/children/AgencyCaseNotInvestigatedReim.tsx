...
const AgencyCaseNotInvestigatedReim: React.FC = () => {
    ...
    const getReAssignClaims = async (role?: string) => {
        try {
            setLoading(true);
            let response: any = await claimsService.getReclaimsAgencyNotCompletedCases();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            setLoading(true);
            let response: any = await claimsService.getReclaimsAgencyNotCompletedCasesByTat(selectedTatRange);
...
export default AgencyCaseNotInvestigatedReim;