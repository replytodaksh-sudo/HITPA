...
// const FieldReassignedCasesReim: React.FC = () => {
...
//   const handleTatRangeChange = (event: SelectChangeEvent<string>) => {
//     const value = event.target.value;
//     setTatRange(value);
//     getCasesByTatRange(value);
//   };

//   const getCssClass = (tat: number): string => {
//     return fetchMenuService.getCashlessCssClass(tat);
//   };

//   const getRowColor = (tat: number): string => {
//     const cssClass = getCssClass(tat);

//     // Map CSS classes to colors
//     switch (cssClass) {
//       case 'tat-light-green':
...
//   const handleInvestigationClick = (claim: ReassignClaim) => {
//     navigate(
//       `/admin/regional-reassign-form/${claim.investigationID}`,
//       {
//         state: {
...
//                     key={index}
//                     sx={{
//                       backgroundColor: getRowColor(claim.tat),
//                       '&:hover': {
//                         opacity: 0.9,
//                         cursor: 'pointer'
//                       }
...
//                       <Link
//                         component="button"
//                         onClick={() => handleInvestigationClick(claim)}
//                         sx={{
//                           color: '#1976d2',
//                           textDecoration: 'none',
//                           fontWeight: 500,
...
//                       </Link>
//                     </TableCell>
//                     <TableCell>{claim.sbigClaimNo}</TableCell>
//                     <TableCell>{claim.tpaClaimNo}</TableCell>
//                     <TableCell>{claim.tpaName}</TableCell>
//                     <TableCell>{claim.proposerName}</TableCell>
//                     <TableCell>{claim.policyCode}</TableCell>
//                     <TableCell>{claim.policyStartDate}</TableCell>
//                     <TableCell>{claim.hospitalName}</TableCell>
//                     <TableCell>{claim.tat}</TableCell>
//                     <TableCell>{claim.hospitalCity}</TableCell>
//                     <TableCell>{claim.hospitalState}</TableCell>
//                     <TableCell>₹{claim.claimAmount?.toLocaleString('en-IN')}</TableCell>
//                     <TableCell>{claim.patientName}</TableCell>
//                     <TableCell>{claim.memberAge}</TableCell>
//                     <TableCell>{claim.finalDiagnosis}</TableCell>
//                     <TableCell>{claim.claimIntimationDate}</TableCell>
//                     <TableCell>{claim.admissionDate}</TableCell>
//                     <TableCell>{claim.dischargeDate}</TableCell>
//                     <TableCell>{claim.workflowStatus}</TableCell>
//                   </TableRow>
//                 ))
//               )}
//             </TableBody>
...
// export default FieldReassignedCasesReim;
...
const FieldReassignedCasesReim: React.FC = () => {
    ...
    const getReAssignClaims = async (role?: string) => {
        try {
            ...
            if (currentRole === 'Regional Manager') {
                response = await claimsService.getReAssignClaimsRegReim();
            } else if (currentRole === 'Agency Spoc') {
                response = await claimsService.getReAssignClaimsReim();
            }
    ...
    const handleViewClick = (investigationID: string, claim: ReassignClaim) => {
        navigate(
            `/admin/regional-reassign-form/${investigationID}?redirectTo=${location.pathname}&claimsType=reim&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}`,
            {
                state: {
                    redirectTo: location.pathname,
                    claimsType: 'cashless',
