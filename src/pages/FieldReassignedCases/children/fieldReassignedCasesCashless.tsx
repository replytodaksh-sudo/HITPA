...
// const FieldReassignedCasesCashless: React.FC = () => {
...
// export default FieldReassignedCasesCashless;
...
const FieldReassignedCasesCashless: React.FC = () => {
  ...
  const handleViewClick = (investigationID: string, claim: ReassignClaim) => {
    navigate(
      `/admin/regional-reassign-form/${investigationID}${investigationID}?redirectTo=${location.pathname}&claimsType=cashless&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}`,
      {
        state: {
          redirectTo: location.pathname,
          claimsType: 'cashless',
