...
const CentralReassignedCasesCashless: React.FC = () => {
  ...
  const fetchClaims = async () => {
    setLoading(true);
    try {
      const response = await claimsService.fetchAllCentralReassignedCasesReim();
...
export default CentralReassignedCasesCashless;