...
const QueriesByClaimsTeamCashless: React.FC = () => {
    ...
    const getReworkClaims = async (role?: string) => {
        try {
            ...
            let response: any = await claimsService.fetchAllQueriesByClaimsTeam();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            ...
            let response: any = await claimsService.fetchAllQueriesByClaimsTeamByTat(selectedTatRange);
    ...
    const handleViewClick = (investigationID: string, claim: ReimClaim) => {
        navigate(
            `/admin/central-assign-agency/${investigationID}?redirectTo=${location.pathname}&claimsType=cashless&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}&acceptAssignId=${claim.acceptAssignId}`,
            {
                state: {
                    claimsType: 'reim',
...
export default QueriesByClaimsTeamCashless;