...
import FoReworkCasesCashless from '../FoReworkCases/children/FoReworkCasesCashless';
...
const FoReassignedCases: React.FC = () => {
...
export default FoReassignedCases;