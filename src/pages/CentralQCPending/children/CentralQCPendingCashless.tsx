...
const CentralQCPendingCashless: React.FC = () => {
    ...
    const getReworkClaims = async (role?: string) => {
        try {
            ...
            let response: any = await claimsService.fetchAllCentralQCPending();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            ...
            let response: any = await claimsService.fetchAllCentralQCPendingByTat(selectedTatRange);
...
export default CentralQCPendingCashless;