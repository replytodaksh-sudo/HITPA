...
const CentralQCPendingReim: React.FC = () => {
    ...
    const getReworkClaims = async (role?: string) => {
        try {
            setLoading(true);
            let response: any = await claimsService.fetchAllCentralQCPendingReim();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            setLoading(true);
            let response: any = await claimsService.fetchAllCentralQCPendingReimByTat(selectedTatRange);
...
export default CentralQCPendingReim;