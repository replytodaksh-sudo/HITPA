...
const AssignedToSelfCashless: React.FC = () => {
    ...
    const fetchAssignedCases = async () => {
        ...
        try {
            ...
            if (role === 'Regional Manager') {
                response = await claimsService.getAssignedToSelfCasesRegional();
            } else if (role === 'Agency Spoc') {
                response = await claimsService.getAssignedToSelfCases();
            }
    ...
    const handleTatChange = async (event: React.ChangeEvent<{ value: unknown }>) => {
        ...
        try {
            ...
            if (role === 'Regional Manager') {
                response = await claimsService.getAssignedToSelfCasesRegionalByTat(selectedRange);
            } else if (role === 'Agency Spoc') {
                response = await claimsService.getAssignedToSelfCasesByTat(selectedRange);
            }
...
export default AssignedToSelfCashless;