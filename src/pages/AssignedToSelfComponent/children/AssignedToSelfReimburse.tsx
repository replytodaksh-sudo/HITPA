...
const AssignedToSelfReimburse: React.FC = () => {
    ...
    const fetchAssignedReimCases = async () => {
        setLoading(true);
        try {
            ...
            console.error('Error fetching assigned reimbursement cases:', error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const columns: GridColDef[] = [
        ...
        { field: 'corporateName', headerName: 'Corporate Name', width: 150 },
...
export default AssignedToSelfReimburse;