// File: src/components/CentralInvestigationCompletedReim.tsx
...
/**
 * Central Investigation Completed Reimbursement Table Component
 * Shows completed reimbursement investigation cases with search and pagination
 */
const CentralInvestigationCompletedReim: React.FC = () => {
  ...
  const handleRowClick = (params: GridRowParams) => {
    const claim = params?.row as ReimClaim;
    navigate(
...
export default CentralInvestigationCompletedReim;