...
const CentralMandatedCasesCashless: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const dropdownItems = fetchMenuService.getCashLessDropDownItems();
    ...
    const loadClaims = async () => {
        ...
        try {
            let response = await claimsService.fetchCentralMandatedCases();
    ...
    const getCasesByTatRange = async (tatValue: string) => {
        ...
        try {
            let response:any = await claimsService.fetchCentralMandatedCasesByTat(tatValue)
    ...
    const handleViewClick = (investigationID: string, claim: ReimClaim) => {
        navigate(
            `/admin/fresh-central-mandate/${investigationID}?claimsType=cashless&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}&acceptAssignId=${claim.acceptAssignId}`
        );
    };
...
export default CentralMandatedCasesCashless;