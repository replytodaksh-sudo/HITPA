...
import QCPenCashless from './children/QCPenCashless';
import QCPenReim from './children/QCPenReim';
...
const RegQCPendingCentral: React.FC = () => {
  ...
  return (
    ...
    //             Regional QC
    //           </Link>
    //           <Typography sx={{ color: 'white', fontWeight: 600 }}>QC Submitted</Typography>
    //         </Breadcrumbs>
    //       </Box>
...
export default RegQCPendingCentral;