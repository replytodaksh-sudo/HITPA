...
const AgencyInvestigationCompletedReim: React.FC = () => {
    ...
    const getReAssignClaims = async (role?: string) => {
        try {
            setLoading(true);
            let response: any = await claimsService.getReclaimsAgencyCompletedCases();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            setLoading(true);
            let response: any = await claimsService.getReclaimsAgencyCompletedCasesByTat(selectedTatRange);
    ...
    const handleViewClick = (investigationID: string, claim: ReassignClaim) => {
        navigate(
            `/admin/agency-case-not-investigated/${investigationID}?redirectTo=${location.pathname}&claimsType=reim&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}`,
            {
                state: {
...
export default AgencyInvestigationCompletedReim;