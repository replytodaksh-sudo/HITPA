...
const AgencyDeniedCasesReim: React.FC = () => {
  ...
  const fetchClaims = async () => {
    setLoading(true);
    try {
      const response = await claimsService.fetchAgencyDeniedCasesReim();
  ...
  const handleViewClick = (investigationID: string, claim: any) => {
    navigate(`/admin/fresh-agency-denied/${investigationID}?claimsType=reim&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}&acceptAssId=${claim.acceptAssignId}`);
  };
...
export default AgencyDeniedCasesReim;