...
const AgencyDeniedCasesCashless: React.FC = () => {
  ...
  const handleViewClick = (investigationID: string, claim: any) => {
    navigate(`/admin/fresh-agency-denied/${investigationID}?claimsType=cashless&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}&acceptAssId=${claim.acceptAssignId}`);
  };
...
export default AgencyDeniedCasesCashless;