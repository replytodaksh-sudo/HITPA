...
const CentralQueryResponseCashless: React.FC = () => {
    ...
    const getReworkClaims = async (role?: string) => {
        try {
            ...
            let response: any = await claimsService.fetchAllCentralQueryResponse();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            ...
            let response: any = await claimsService.fetchAllCentralQueryResponseByTat(selectedTatRange);
...
export default CentralQueryResponseCashless;