...
const CentralQueryResponseReim: React.FC = () => {
    ...
    const getReworkClaims = async (role?: string) => {
        try {
            setLoading(true);
            let response: any = await claimsService.fetchAllCentralQueryResponseReim();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            setLoading(true);
            let response: any = await claimsService.fetchAllCentralQueryResponseReimByTat(selectedTatRange);
...
export default CentralQueryResponseReim;