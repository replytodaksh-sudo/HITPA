...
const AgencyReworkCasesReim: React.FC = () => {
    ...
    const getReworkClaims = async (role?: string) => {
        try {
            setLoading(true);
            let response: any = await claimsService.getReworkReclaims();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            setLoading(true);
            let response: any = await claimsService.getReworkReclaimsByTat(selectedTatRange);
...
export default AgencyReworkCasesReim;