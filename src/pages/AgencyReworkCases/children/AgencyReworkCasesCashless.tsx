...
const AgencyReworkCasesCashless: React.FC = () => {
    ...
    const getReworkClaims = async (role?: string) => {
        try {
            ...
            let response: any = await claimsService.getReworkClaims();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            ...
            let response: any = await claimsService.getReworkClaimsByTat(selectedTatRange);
...
export default AgencyReworkCasesCashless;