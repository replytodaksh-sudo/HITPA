...
const CompletedCaseNotInvestigatedCashless: React.FC = () => {
  ...
  const fetchClaims = async () => {
    setLoading(true);
    try {
      const response = await claimsService.getNotCompletedCasesRegional();
...
export default CompletedCaseNotInvestigatedCashless;