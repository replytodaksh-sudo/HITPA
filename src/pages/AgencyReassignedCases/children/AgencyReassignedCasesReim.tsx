...
const AgencyReassignedCasesReim: React.FC = () => {
    ...
    const handleViewClick = (investigationID: string, claim: ReassignClaim) => {
        navigate(
            `/admin/agency-reassign-form/${investigationID}?redirectTo=${location.pathname}&claimsType=reim&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}`,
            {
                state: {
...
export default AgencyReassignedCasesReim;