...
const CentralQueryResponsePendingCashless: React.FC = () => {
    ...
    const getReworkClaims = async (role?: string) => {
        try {
            ...
            let response: any = await claimsService.fetchAllCentralQueryResponsePending();
    ...
    const getCasesByTatRange = async (selectedTatRange: string) => {
        ...
        try {
            ...
            let response: any = await claimsService.fetchAllCentralQueryResponsePendingByTat(selectedTatRange);
    ...
    const handleViewClick = (investigationID: string, claim: ReimClaim) => {
        navigate(
            `/admin/central-qc-form/${investigationID}?redirectTo=${location.pathname}&claimsType=cashless&claimNo=${claim.tpaClaimNo}&sbigclaimno=${claim.sbigClaimNo}&acceptAssignId=${claim.acceptAssignId}`,
            {
                state: {
                    claimsType: 'reim',
...
export default CentralQueryResponsePendingCashless;