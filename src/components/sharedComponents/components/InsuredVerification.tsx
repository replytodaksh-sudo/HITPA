...
//   const [tabCheck, setTabCheck] = useState<any>({
//     employeerVisit: false,
//     hospitalVisit: false,
//     insuredPersonVisit: true
//   });

//   useEffect(() => {
//     if (previousData) {
//       setFormData({
//         insuredVisitDone: previousData.insuredVisitDone ?? null,
//         insuredAppointmentTaken: convertBoolToString(previousData.insuredAppointmentTaken) || '',
//         insureName: previousData.insureName || '',
//         insuredContactNumber: previousData.insuredContactNumber || '',
//         insuredReason: previousData.insuredReason || '',
//         insuredStatementCollected: previousData.insuredStatementCollected ?? null,
//         insuredStatementCollectedReason: previousData.insuredStatementCollectedReason || '',
//         insuredDiscrepanciesFound: previousData.insuredDiscrepanciesFound ?? null,
//         insuredPEDNoted: previousData.insuredPEDNoted ?? null,
//         insuredPEDFinding: previousData.insuredPEDFinding || '',
//         insuredPastDocumentCollected: previousData.insuredPastDocumentCollected ?? null,
//         insuredPastDocumentSpecify: previousData.insuredPastDocumentSpecify || '',
//         insuredPastDocumentReason: previousData.insuredPastDocumentReason || '',
//         insuredAlcoholHistory: previousData.insuredAlcoholHistory ?? null,
//         insuredSmokingHistory: previousData.insuredSmokingHistory ?? null,
//         insuredAnyOtherHabits: previousData.insuredAnyOtherHabits === 'yes' ? true : previousData.insuredAnyOtherHabits === 'no' ? false : null,
//         insuredOtherHabits: previousData.insuredOtherHabits || '',
//         insuredAlcoholQuantity: previousData.insuredAlcoholQuantity || '',
//         insuredSmokingQuantity: previousData.insuredSmokingQuantity || '',
//         insuredKYCCollected: previousData.insuredKYCCollected ?? null,
//         insuredKYCDiscrepancies: previousData.insuredKYCDiscrepancies || '',
//         insuredKYCReason: previousData.insuredKYCReason || '',
//         insuredFamilyPhysicianName: previousData.insuredFamilyPhysicianName || '',
//         insuredFamilyPhysicianContactNo: previousData.insuredFamilyPhysicianContactNo || '',
//         insuredFamilyPhysicianRegNo: previousData.insuredFamilyPhysicianRegNo || '',
//         insuredFamilyPhysicianIsStatementCollected: previousData.insuredFamilyPhysicianIsStatementCollected ?? null,
//         insuredFamilyPhysicianPEDNoted: convertBoolToString(previousData.insuredFamilyPhysicianPEDNoted) || '',
//         insuredFamilyPhysicianIsDiscrepancyNoted: convertBoolToString(previousData.insuredFamilyPhysicianIsDiscrepancyNoted) || '',
//         insuredFamilyPhysicianDiscrepancyFindings: previousData.insuredFamilyPhysicianDiscrepancyFindings || '',
//         insuredFamilyPhysicianNoStatementCollectedReason: previousData.insuredFamilyPhysicianNoStatementCollectedReason || '',
//         insuredReferralDoctorName: previousData.insuredReferralDoctorName || '',
//         insuredReferralDoctorContactNo: previousData.insuredReferralDoctorContactNo || '',
//         insuredReferralDoctorRegNo: previousData.insuredReferralDoctorRegNo || '',
//         insuredReferralDoctorIsStatementCollected: previousData.insuredReferralDoctorIsStatementCollected ?? null,
//         insuredReferralDoctorPEDNoted: convertBoolToString(previousData.insuredReferralDoctorPEDNoted) || '',
//         insuredReferralDoctorIsDiscrepancyNoted: convertBoolToString(previousData.insuredReferralDoctorIsDiscrepancyNoted) || '',
//         insuredReferralDoctorPEDFindings: previousData.insuredReferralDoctorPEDFindings || '',
//         insuredReferralDoctorDiscrepancyFindings: previousData.insuredReferralDoctorDiscrepancyFindings || '',
//         insuredReferralDoctorNoStatementCollectedReason: previousData.insuredReferralDoctorNoStatementCollectedReason || '',
//         insuredFamilyPhysicianIsVicinityChecked: convertBoolToString(previousData.insuredFamilyPhysicianIsVicinityChecked) || '',
//         insuredFamilyPhysicianVicinityFindings: previousData.insuredFamilyPhysicianVicinityFindings || '',
//         insuredAnyOtherInvestigationFindings: previousData.insuredAnyOtherInvestigationFindings || '',
//       });
//     }
//   }, [previousData]);
...
//   const convertBoolToString = (val: boolean | null | undefined): string => {
//     if (val === true) return 'true';
...
//       insuredAppointmentTaken: convertToBoolean(formData.insuredAppointmentTaken),
//       insuredFamilyPhysicianPEDNoted: convertToBoolean(formData.insuredFamilyPhysicianPEDNoted),
//       insuredFamilyPhysicianIsDiscrepancyNoted: convertToBoolean(formData.insuredFamilyPhysicianIsDiscrepancyNoted),
//       insuredReferralDoctorPEDNoted: convertToBoolean(formData.insuredReferralDoctorPEDNoted),
//       insuredReferralDoctorIsDiscrepancyNoted: convertToBoolean(formData.insuredReferralDoctorIsDiscrepancyNoted),
//       insuredFamilyPhysicianIsVicinityChecked: convertToBoolean(formData.insuredFamilyPhysicianIsVicinityChecked),
//       btnAction: 'submittoqc',
//     };
...
//     if (!tabCheck.employeerVisit && !tabCheck.hospitalVisit && tabCheck.insuredPersonVisit) {
//       return 'Submit To QC 1';
//     }
//     if (!tabCheck.employeerVisit && tabCheck.hospitalVisit && tabCheck.insuredPersonVisit) {
//       return 'Submit To QC 2';
//     }
//     return 'Submit';
//   };

//   const showSubmitButton = () => {
//     return (!tabCheck.employeerVisit && !tabCheck.hospitalVisit && tabCheck.insuredPersonVisit) ||
...
//             <RadioGroup
//               row
//               value={formData.insuredVisitDone === null ? '' : formData.insuredVisitDone.toString()}
//               onChange={(e) => handleChange('insuredVisitDone', e.target.value === 'true')}
//             >
//               <FormControlLabel value="true" control={<Radio disabled={!buttonEnable} />} label="Yes" />
//               <FormControlLabel value="false" control={<Radio disabled={!buttonEnable} />} label="No" />
//             </RadioGroup>
//           </FormControl>
//         </Grid>
...
//             <RadioGroup
//               row
//               value={formData.insuredStatementCollected === null ? '' : formData.insuredStatementCollected.toString()}
//               onChange={(e) => handleChange('insuredStatementCollected', e.target.value === 'true')}
//             >
//               <FormControlLabel value="true" control={<Radio disabled={!buttonEnable} />} label="Yes" />
//               <FormControlLabel value="false" control={<Radio disabled={!buttonEnable} />} label="No" />
//             </RadioGroup>
...
//               label="Reason"
//               value={formData.insuredStatementCollectedReason}
//               onChange={(e) => handleChange('insuredStatementCollectedReason', e.target.value)}
//               disabled={!buttonEnable}
//               sx={{ mt: 2 }}
//             />
//           )}
...
//               <RadioGroup
//                 row
//                 value={formData.insuredDiscrepanciesFound === null ? '' : formData.insuredDiscrepanciesFound.toString()}
//                 onChange={(e) => handleChange('insuredDiscrepanciesFound', e.target.value === 'true')}
//               >
//                 <FormControlLabel value="true" control={<Radio disabled={!buttonEnable} />} label="Yes" />
//                 <FormControlLabel value="false" control={<Radio disabled={!buttonEnable} />} label="No" />
//               </RadioGroup>
...
//               <RadioGroup
//                 row
//                 value={formData.insuredPEDNoted === null ? '' : formData.insuredPEDNoted.toString()}
//                 onChange={(e) => handleChange('insuredPEDNoted', e.target.value === 'true')}
//               >
//                 <FormControlLabel value="true" control={<Radio disabled={!buttonEnable} />} label="Yes" />
//                 <FormControlLabel value="false" control={<Radio disabled={!buttonEnable} />} label="No" />
...
//                   <RadioGroup
//                     row
//                     value={formData.insuredPastDocumentCollected === null ? '' : formData.insuredPastDocumentCollected.toString()}
//                     onChange={(e) => handleChange('insuredPastDocumentCollected', e.target.value === 'true')}
//                   >
//                     <FormControlLabel value="true" control={<Radio disabled={!buttonEnable} />} label="Yes" />
//                     <FormControlLabel value="false" control={<Radio disabled={!buttonEnable} />} label="No" />
//                   </RadioGroup>
...
//                     value={formData.insuredPastDocumentSpecify}
//                     onChange={(e) => handleChange('insuredPastDocumentSpecify', e.target.value)}
//                     disabled={!buttonEnable}
//                   />
//                 )}
//                 {formData.insuredPastDocumentCollected === false && (
...
//                     label="Reason"
//                     value={formData.insuredPastDocumentReason}
//                     onChange={(e) => handleChange('insuredPastDocumentReason', e.target.value)}
//                     disabled={!buttonEnable}
//                   />
//                 )}
//               </Box>
...
//               <RadioGroup
//                 row
//                 value={formData.insuredAlcoholHistory === null ? '' : formData.insuredAlcoholHistory.toString()}
//                 onChange={(e) => handleChange('insuredAlcoholHistory', e.target.value === 'true')}
//               >
//                 <FormControlLabel value="true" control={<Radio disabled={!buttonEnable} />} label="Yes" />
//                 <FormControlLabel value="false" control={<Radio disabled={!buttonEnable} />} label="No" />
//               </RadioGroup>
//             </FormControl>
//             {formData.insuredAlcoholHistory === true && (
//               <TextField
//                 fullWidth
//                 label="Quantity"
//                 placeholder="Quantity"
...
//               <RadioGroup
//                 row
//                 value={formData.insuredSmokingHistory === null ? '' : formData.insuredSmokingHistory.toString()}
//                 onChange={(e) => handleChange('insuredSmokingHistory', e.target.value === 'true')}
//               >
//                 <FormControlLabel value="true" control={<Radio disabled={!buttonEnable} />} label="Yes" />
//                 <FormControlLabel value="false" control={<Radio disabled={!buttonEnable} />} label="No" />
//               </RadioGroup>
//             </FormControl>
//             {formData.insuredSmokingHistory === true && (
//               <TextField
//                 fullWidth
//                 label="Quantity"
//                 placeholder="Quantity"
...
//               <RadioGroup
//                 row
//                 value={formData.insuredAnyOtherHabits === null ? '' : formData.insuredAnyOtherHabits.toString()}
//                 onChange={(e) => handleChange('insuredAnyOtherHabits', e.target.value === 'true')}
//               >
//                 <FormControlLabel value="true" control={<Radio />} label="Yes" />
//                 <FormControlLabel value="false" control={<Radio />} label="No" />
//               </RadioGroup>
//             </FormControl>
//             {formData.insuredAnyOtherHabits === true && (
//               <TextField
//                 fullWidth
//                 multiline
//                 rows={5}
...
//               <RadioGroup
//                 row
//                 value={formData.insuredKYCCollected === null ? '' : formData.insuredKYCCollected.toString()}
//                 onChange={(e) => handleChange('insuredKYCCollected', e.target.value === 'true')}
//               >
//                 <FormControlLabel value="true" control={<Radio disabled={!buttonEnable} />} label="Collected" />
//                 <FormControlLabel value="false" control={<Radio disabled={!buttonEnable} />} label="Not Collected" />
//               </RadioGroup>
//             </FormControl>
//             {formData.insuredKYCCollected === true && (
//               <TextField
...
//             label="Contact Number"
//             value={formData.insuredFamilyPhysicianContactNo}
//             onChange={(e) => handleChange('insuredFamilyPhysicianContactNo', e.target.value)}
//             disabled={!buttonEnable}
//             sx={{ mb: 2 }}
//           />
//           <TextField
...
//             <RadioGroup
//               row
//               value={formData.insuredFamilyPhysicianIsStatementCollected === null ? '' : formData.insuredFamilyPhysicianIsStatementCollected.toString()}
//               onChange={(e) => handleChange('insuredFamilyPhysicianIsStatementCollected', e.target.value === 'true')}
//             >
//               <FormControlLabel value="true" control={<Radio disabled={!buttonEnable} />} label="Yes" />
//               <FormControlLabel value="false" control={<Radio disabled={!buttonEnable} />} label="No" />
//             </RadioGroup>
...
//                 <Select
//                   value={formData.insuredFamilyPhysicianPEDNoted}
//                   onChange={(e) => handleChange('insuredFamilyPhysicianPEDNoted', e.target.value)}
//                   disabled={!buttonEnable}
//                 >
//                   <MenuItem value="">Select</MenuItem>
//                   <MenuItem value="true">Yes</MenuItem>
...
//                 <Select
//                   value={formData.insuredFamilyPhysicianIsDiscrepancyNoted}
//                   onChange={(e) => handleChange('insuredFamilyPhysicianIsDiscrepancyNoted', e.target.value)}
//                   disabled={!buttonEnable}
//                 >
//                   <MenuItem value="">Select</MenuItem>
//                   <MenuItem value="true">Yes</MenuItem>
